...
class SSPlayerSpaz(PlayerSpaz):
	...
	def handlemessage(self, msg: Any) -> Any:
		if isinstance(msg, ba.HitMessage):
			...
			Spaz.handlemessage(self, ba.HitMessage) # Augment standard behavior.
...
# ba_meta export game
class SuperSmashElimination(ba.TeamGameActivity[Player2, Team2]):
	...
	def on_begin(self) -> None:
		...
		self._tnt_drop_timer = ba.timer(1.0 * 0.30,
										...
										repeat=True)
		self._update_icons()
		ba.timer(0.5, self.check_end_game)
